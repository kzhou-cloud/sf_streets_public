...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Finetune Whisper on synthetic US Streets audio data with 'I'm on' prefix"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="all_us_streets",
        help="Name of the voice cloning project directory (default: all_us_streets)"
    )
    parser.add_argument(
        "--synthetic_data_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.01,
        help="Weight decay regularization (default: 0.01)"
    )
    parser.add_argument(
        "--warmup_steps", 
        type=int, 
    ...
    parser.add_argument(
        "--wandb_project",
        type=str,
        default="whisper-us-streets-synthetic-im-on",
